package com.example.bt07.controller.token;

import com.example.bt07.config.jwt.JwtFactory;
import com.example.bt07.config.jwt.JwtProperties;
import com.example.bt07.domain.RefreshToken;
import com.example.bt07.domain.User;
import com.example.bt07.dto.token.CreateAccessTokenRequest;
...
//        userRepository.deleteAll();
    ...
    public void createNewAccessTokenTest() throws Exception{
        ...
        User testUser = userRepository.save(User.builder().email("test@email").password("test").build());
